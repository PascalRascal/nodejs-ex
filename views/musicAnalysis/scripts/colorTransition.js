...
function calculateDistanceColor(colorArray1, colorArray2) {
	var distance = [];
...
function startTransition(currentColor, targetColor, visualizer) {
	...
	distance	= calculateDistanceColor(currentColor, targetColor);
	increment	= calculateIncrement(distance, fps, duration);
	
	transHandler = setInterval(function() {
		transition(currentColor, targetColor, visualizer);
	}, 1000/fps);
}

/* ==================== Transition Calculator ==================== */
function transition(currentColor, targetColor, visualizer) {
	// checking R
	...
	visualizer.barColor = rgb2hex(currentColor);
    visualizer.shadowColor = rgb2hex(currentColor);
    visualizer.setCanvasStyles();
